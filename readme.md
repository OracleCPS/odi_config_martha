...
![](images/100/media/image10.png)
    ...
    8.  The `Prerequisites` screen is just a list of items that you must check and verify before you can proceed. Check the boxes and then click on the "Next" button.  **NOTE: The Upgrade Assistant will not verify that the prerequisites have been met**.
![](images/100/media/image11.png)

    9. On `OPSS Schema` screen, provide the DB admin user (SYS as sysdba) and its password, then click the "Connect" button
...
![](images/100/media/image12.png)
    ...
    11. On `ODI Schema` screen, provide the DB admin user (SYS as sysdba) and its password, then click the "Connect" button.
...
![](images/100/media/image15.png)
    ...
    16. On `MDS Schema` screen, provide the DB admin user (SYS as sysdba) and its password, then click the "Connect" button (if users and passwords are the same as the previous screens, the application will automatically provide them)
...
![](images/100/media/image16.png)
    ...
    18. On `IAU Schema` screen, provide the DB admin user (SYS as sysdba) and its password, then click the "Connect" button (if users and passwords are the same as the previous screens, the application will automatically provide them)
...
![](images/100/media/image17.png)
    ...
    20. On `STB Schema` screen, provide the DB admin user (SYS as sysdba) and its password, then click the "Connect" button (if users and passwords are the same as the previous screens, the application will automatically provide them)
...
![](images/100/media/image18.png)
    ...
    22. On `WLS Schema` screen, provide the DB admin user (SYS) and its password, then click the "Connect" button (if users and passwords are the same as the previous screens, the application will automatically provide them)
